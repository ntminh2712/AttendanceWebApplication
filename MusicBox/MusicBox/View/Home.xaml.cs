...
namespace MusicBox.View
{
    ...
    {
        public ObservableCollection<Song> listSongs;
        public ObservableCollection<Song> ListSongs { get => listSongs; set => listSongs = value; }
        ...
        public async void getSongHome()
        {
            ...
            var response = httpClient.GetAsync("https://2-dot-backup-server-002.appspot.com/_api/v2/songs").Result;
        ...
        private void PlayMusic(object sender, TappedRoutedEventArgs e)
        {
            ...
            Debug.WriteLine(Recently.listRecently.Count);
